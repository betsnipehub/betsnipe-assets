(function () {
  ...
  function enableHorizontalDrag(selector) {
    ...
    scroller.addEventListener("pointerdown", (event) => {
      /*
        Drag manual apenas para rato.
        Em touch/mobile deixamos o browser gerir o gesto,
        para permitir scroll vertical da página sobre os cartões.
      */
    ...
    /*
      Não converter scroll vertical em scroll horizontal.
      Isto era o que fazia a página ficar presa quando o utilizador tentava
      fazer scroll vertical sobre a Loja de Pontos.
      O scroll horizontal por trackpad continua a funcionar naturalmente
      através do overflow-x do .store-grid.
    */
  });
}
