(function () {
  const BETSNIPE_PROMO_VERSION = "en-v22";
  const ROOT_SELECTOR =
  ...
  function initPage(pageRoot) {
    ...
    */
    ...
    /*
      ...
      The hidden .modal-sections-template container inside
      each bonus card is the single source of truth for the
      promotion terms.
    */
    ...
    if (accordion) {
      modal.addEventListener(
        ...
        (event) => {
          ...
          /*
            O listener fica no modal, acima do acordeão,
            para impedir que versões antigas ou instâncias
            duplicadas processem o mesmo clique novamente.
          */
