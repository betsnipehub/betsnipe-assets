...
function openLoginPopup() {
  ...
  const loginButton = Array.from(document.querySelectorAll("button, a, [role='button']")).find((element) => {
...
document.addEventListener("visibilitychange", () => {
  ...
  function openModalFromCard(card) {
    ...
    const cardImage = card.querySelector(".bonus-image img, .worldcup-banner-img-desktop, .worldcup-banner-img");
  ...
  button.addEventListener("click", () => {
    const card = button.closest(".bonus-card, .worldcup-banner");
